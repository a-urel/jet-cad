...
**01–05 are executed, merged and looked at; 06 is merged (`a6837d0`) with its look OWED; 07 is merged (`63c3878`), with its deferred defects fixed on `fix/post-07` (`1ae83f9`)**; the other six have not started. Update
